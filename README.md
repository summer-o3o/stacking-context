...
따로 정리를 해야겠다는 생각에 정리를 하게되었습니다.<br>
이제 z-index 와 Stacking Contexts 라는 것에 대해 알아봅시다.<br><br>

저는 z-index를 정확하게 알고 있는 사람들이 적다고 생각합니다.<br>
저와 같이 문제를 풀면서, z-index의 정확한 개념을 익혀봅시다.
